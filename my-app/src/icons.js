export function EditIcon() {
    // this is from https://icons.getbootstrap.com/icons/pencil/
...
export function TrashIcon() {
    // this is from https://icons.getbootstrap.com/icons/trash/
    return (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
...
export function XIcon() {
    // this is from https://icons.getbootstrap.com/icons/x-lg/
...
export function ThreeDotsIcon() {
    // this is from https://icons.getbootstrap.com/icons/three-dots-vertical/
    return (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
